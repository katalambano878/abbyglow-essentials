                                ...
                                >
                                    ...
                                    <div className="p-3 flex flex-col flex-1">
                                        ...
                                        <div className="flex items-center justify-between mt-2 pt-2">
                                            ...
                                            <button className="w-8 h-8 rounded-full bg-brand-soft text-brand flex items-center justify-center group-hover:bg-brand-dark group-hover:text-white transition-colors">
                    ...
                    <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                        {completedOrder ? (
                            ...
                            <div className="p-8 text-center flex flex-col items-center justify-center space-y-6 overflow-y-auto">
                                <div className={`w-20 h-20 rounded-full flex items-center justify-center ${completedOrder.paymentPending ? 'bg-amber-100' : 'bg-brand-soft'}`}>
                                    <i className={`text-5xl ${completedOrder.paymentPending ? 'ri-time-line text-amber-600' : 'ri-checkbox-circle-fill text-brand'}`}></i>
                                </div>
                                <div>
                                    ...
                                    {!completedOrder.paymentPending && paymentMethod === 'cash' && changeDue > 0 && (
                                        <div className="mt-3 bg-brand-soft border border-brand/30 rounded-lg p-3">
                            ...
                            <>
                                ...
                                <div className="p-6 space-y-6 overflow-y-auto">
                                    ...
                                    {/* Total Display */}
                                    <div className="text-center py-4 bg-brand-soft rounded-xl border border-brand/30">
                                    ...
                                    <div>
                                        ...
                                        {selectedCustomer && (
                                            <div className="bg-brand-soft border border-brand/30 rounded-lg p-3 mb-2 flex items-center justify-between">
                                                <div>
                                    ...
                                    <div>
                                        ...
                                        {deliveryMethod === 'doorstep' && (
                                            <div className="mt-3 bg-brand-soft p-4 rounded-lg border border-brand/30 space-y-3">
                                    ...
                                    {/* Card info */}
                                    {paymentMethod === 'card' && (
                                        <div className="bg-brand-soft border border-brand/30 rounded-lg p-3">
                                            <div className="flex items-start space-x-2">
