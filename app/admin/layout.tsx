      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto">
          <Link href="/admin" className="flex items-center gap-2 mb-8 px-2 cursor-pointer">
            <Image src="/logo.png" alt="AbbyGlow Essentials" width={574} height={433} className="h-8 w-auto object-contain" />
          ...
          <div className="px-4 py-4 lg:px-6 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <div className="relative user-menu-container">
                ...
                >
                  <div className="w-8 h-8 lg:w-9 lg:h-9 flex items-center justify-center bg-brand-soft text-brand rounded-full font-semibold">
