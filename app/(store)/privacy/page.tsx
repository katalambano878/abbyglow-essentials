export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-white">
      <div className="bg-gradient-to-br from-brand-soft via-white to-amber-50 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-brand-soft border border-brand/30 p-6 rounded-xl">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-brand-soft rounded-full flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us through the contact form on our website or through your account settings. We will respond within 30 days.
            </p>
          </section>
