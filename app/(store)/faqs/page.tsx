...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'For hygiene and safety reasons, we cannot accept returns on opened personal-care items, intimate apparel, earrings, or perishable goods. Custom or personalised items are also non-returnable unless defective.'
    },
    {
      category: 'returns',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20 pb-8">
        <div className="relative">
          <input
            ...
            className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-full focus:ring-2 focus:ring-brand focus:border-transparent text-sm shadow-lg bg-white"
          />
      ...
      <div className="bg-gradient-to-br from-brand to-brand-dark py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-brand px-8 py-4 rounded-full font-medium hover:bg-brand-soft transition-colors whitespace-nowrap"
            >
            ...
            {SITE_PHONE_SECONDARY && (
              <a
                href={whatsAppUrl(SITE_PHONE_SECONDARY)}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-brand-dark text-white px-8 py-4 rounded-full font-medium hover:bg-brand transition-colors whitespace-nowrap"
              >
                <i className="ri-whatsapp-line text-lg"></i>
                WhatsApp {SITE_PHONE_SECONDARY}
              </a>
            )}
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/shipping" className="bg-gray-50 p-8 rounded-2xl hover:shadow-lg transition-all cursor-pointer">
            <div className="w-12 h-12 bg-brand-soft rounded-full flex items-center justify-center mb-4">
