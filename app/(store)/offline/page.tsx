...
export default function OfflinePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-soft via-white to-brand-soft flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <div className="relative mb-8">
          <div className="w-32 h-32 mx-auto relative">
            ...
            {/* Inner circle */}
            <div className="absolute inset-3 rounded-full bg-gradient-to-br from-brand-soft to-brand-soft flex items-center justify-center">
        ...
        <div className="space-y-3 mb-8">
          <button
            onClick={handleRetry}
            disabled={retrying}
            className="w-full bg-brand hover:bg-brand-dark disabled:bg-brand/50 text-white py-4 px-6 rounded-2xl font-semibold transition-all active:scale-[0.98] shadow-lg shadow-brand/20 flex items-center justify-center gap-2"
          >
            {retrying ? (
              <>
        ...
        <div className="mt-6 flex items-center justify-center gap-2">
          <div className={`w-2 h-2 rounded-full ${isOnline ? 'bg-brand-soft0' : 'bg-red-400'} ${!isOnline && 'animate-pulse'}`} />
