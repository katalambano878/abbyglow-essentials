        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
            <div className="flex items-center gap-3 md:gap-4 w-full md:w-auto">
              <div className="w-12 h-12 md:w-16 md:h-16 flex-shrink-0 rounded-full bg-brand-soft flex items-center justify-center text-brand text-xl md:text-2xl font-bold shadow-inner border-2 border-white">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-8 min-h-[500px]">
                {activeTab === 'profile' && (
                  <div className="max-w-2xl">
                    ...
                    {profileMessage.text && (
                      <div className={`mb-6 p-4 rounded-xl flex items-start gap-3 ${profileMessage.type === 'success' ? 'bg-brand-soft text-brand border border-brand/20' : 'bg-red-50 text-red-700 border border-red-100'}`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-brand-soft focus:border-brand transition-all bg-gray-50 focus:bg-white"
                          />
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-11 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-brand-soft focus:border-brand transition-all bg-gray-50 focus:bg-white"
                          />
                        </div>
                      </div>
                    ...
                    <div className="mt-12 pt-12 border-t border-gray-100">
                      ...
                      {passwordMessage.text && (
                        <div className={`mb-6 p-4 rounded-xl flex items-start gap-3 ${passwordMessage.type === 'success' ? 'bg-brand-soft text-brand border border-brand/20' : 'bg-red-50 text-red-700 border border-red-100'}`}>
                      ...
                      {securityOptions.map((option, index) => (
                        ...
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center group-hover:bg-brand-soft group-hover:text-brand transition-colors flex-shrink-0">
                          ...
                          <div className="flex items-center gap-3 flex-shrink-0">
                            {option.status === 'verified' && (
                              <span className="text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-1 bg-brand-soft text-brand rounded-full flex items-center gap-1">
