export default function MaintenancePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-soft via-white to-amber-50 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          <div className="w-32 h-32 bg-brand-soft rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <div className="bg-brand-soft border border-brand/30 rounded-2xl p-8 mb-8">
        ...
        <div className="text-gray-500 text-sm">
          ...
          <p>Follow your configured social channels for real-time updates</p>
        </div>
      </div>
    </div>
  );
