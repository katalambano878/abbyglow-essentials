...
const BLOG_POST_SEO: Record<string, { title: string; description: string; image: string; author: string }> = {
  '1': {
    ...
    description: 'Learn how to shop online safely and confidently in Ghana with this comprehensive ecommerce guide from AbbyGlow Essentials.',
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    ogType: 'article',
    author: post.author,
    keywords: ['online shopping Ghana', 'AbbyGlow Essentials tips'],
  });
}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-brand-soft transition-colors cursor-pointer">
        ...
        <div className="mt-16 bg-gradient-to-br from-brand to-brand-dark rounded-2xl p-12 text-center text-white">
          ...
          <form className="max-w-md mx-auto flex gap-3">
            ...
            <button
              type="submit"
              className="bg-white text-brand px-8 py-4 rounded-full font-medium hover:bg-brand-soft transition-colors whitespace-nowrap"
            >
              Subscribe
            </button>
          </form>
