  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-brand to-brand-dark text-white rounded-full shadow-2xl hover:scale-110 transition-transform z-50 flex items-center justify-center"
      >
        {isOpen ? (
              ...
              >
                <div className={`max-w-[75%] ${msg.sender === 'user' ? 'order-2' : 'order-1'}`}>
                  <div className={`px-4 py-2 rounded-2xl ${
                    msg.sender === 'user'
                      ? 'bg-brand-soft0 text-white rounded-br-sm'
          ...
          <div className="border-t border-gray-200 p-3 bg-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-9 h-9 flex items-center justify-center bg-brand-soft0 hover:bg-brand-dark text-white rounded-full transition-colors"
              >
